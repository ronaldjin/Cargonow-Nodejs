(function () {
    ...
    angular.module('ad.promotion')
        .directive('svHomeBanner', function (AdServ, $timeout, $mdMedia,$interval) {
            return {
                replace: true,
                templateUrl: 'scripts/ad/promotion/directives/sv-home-banner.html',
                scope: {
                    place: '@'
                },
