    ...
    angular.module('events', ['ui.router', 'mwl.calendar'])
        .config(function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                ...
                .state("app.events.kohl2016", {
                    url: "/kohl2016",
                    controller: "Kohl2016Ctrl",
                    templateUrl: "scripts/events/views/kohl2016Ctrl.html"
                })
                ...
                .state("app.events.kohl2015.photo-gallery", {
                    url: "/photo-gallery/:photoId",
