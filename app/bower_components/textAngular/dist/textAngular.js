...
// tests against the current jqLite/jquery implementation if this can be an element
    ...
    angular.module('textAngular.DOM', ['textAngular.factories'])
        ...
        }]).service('taSelection', ['$window', '$document', 'taDOM', '$rootScope',
            /* istanbul ignore next: all browser specifics and PhantomJS dosen't seem to support half of it */
            function ($window, $document, taDOM, $rootScope) {
    ...
    angular.module('textAngular.taBind', ['textAngular.factories', 'textAngular.DOM'])
        ...
        .directive('taBind', [
            ...
            function (taSanitize, $timeout, $window, $document, taFixChrome, taBrowserTag,
                      taSelection, taSelectableElements, taApplyCustomRenderers, taOptions,
                      _taBlankTest, $parse, taDOM) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    scope.displayElements = {
                        ...
                        popover: angular.element('<div class="popover sv-popover fade bottom" style="max-width: none; width: 305px;"></div>'),
